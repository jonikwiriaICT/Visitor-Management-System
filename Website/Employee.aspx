<%@ Page Title="" Language="C#" MasterPageFile="~/VisitorMaster.master" AutoEventWireup="true" CodeFile="Employee.aspx.cs" Inherits="Employee" ValidateRequest ="false"  %>
                                ...
                                <div class="box-body box-profile">
                                    ...
                                    <asp:Panel ID="PnlEmployee" runat="server">
                                       ...
                                       <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <asp:DropDownList ID="Department_id" CssClass ="form-control" runat="server"></asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label style="font-size: 12px">Employee Name</label>
                                            </div>
                                            <div class="col-md-9">
