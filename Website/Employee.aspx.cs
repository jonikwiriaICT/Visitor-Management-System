...
public partial class Employee : System.Web.UI.Page
{
    ...
    public void bindGrid(int currentPage)
    {
        ...
        TableResult.DataSource = objAdm.PopulateData(currentPage, "GetEmployee");
    ...
    private void GetDepartment()
    {
        try
        {
            ...
            Department_id.DataSource = ds;
            Department_id.DataTextField = "Desc";
            Department_id.DataValueField = "Code";
    ...
    protected void SaveChangesClicked(object sender, EventArgs e)
    {
        try
        {
            if (Administrator() == "1")
            {
                ...
                if (itrig == 0)
                {
                    if (objAdm.CRUDEmployee(rec_id.Value, Department_id.SelectedValue , Email .Text , objAdm .Encrypt ("welcome"), Name.Text , userTypeID .SelectedValue , "INSERT") == true)
                    {
                        LoadGrid();
                ...
                if (itrig == 1)
                {
                    if (objAdm.CRUDEmployee(rec_id.Value, Department_id.SelectedValue, Email.Text, objAdm.Encrypt("welcome"), Name.Text, userTypeID.SelectedValue, "UPDATE") == true)
                    {
                        LoadGrid();
                        DisplaySuccess(objAdm.ErrorMessage);
