<%@ Page Title="" Language="C#" MasterPageFile="~/VisitorMaster.master" AutoEventWireup="true" CodeFile="LoginReport.aspx.cs" Inherits="LoginReport" ValidateRequest ="false"  %>
                    ...
                    <div class="panel">
                        <div class="panel-heading ">
                            <div class="panel-title ">
                                <h4>Visitor Logged in Information</h4>
                ...
                <div id="TableView" runat="server">
                    <div class="nav-tabs-custom">
                        <div class="panel ">
                            <div class="panel-heading ">
                                <div class="panel-title ">
                                    <h4>Visitor Logged in Report</h4>
                                    <br />
                                </div>
                            </div>
                            <div class="panel-body">
                                    ...
                                    <div class="box-body box-profile">
                                        <div class="table-responsive">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderStyle-Width="5%"   HeaderText="Log Out Visitor" ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
